 ...
 */
public class ColumnaExport extends DefaultExportableConfig<ColumnaDomain> {

    public static ColumnaExport from(ColumnaDetailView detail) {
        return new ColumnaExport(detail);
    }

    public ColumnaExport(ColumnaDetailView detail) {
        super(detail);
    }
